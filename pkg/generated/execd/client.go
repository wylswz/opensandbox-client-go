...
// APIClient manages communication with the OpenSandbox Execd API API v1.0.0
...
type APIClient struct {
	...
	CodeInterpretingAPI *CodeInterpretingAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.CodeInterpretingAPI = (*CodeInterpretingAPIService)(&c.common)
