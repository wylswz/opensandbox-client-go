...
type Sandbox struct {
	...
	Id string `json:"id"`
	// Container image specification used to provision this sandbox. Only present in responses for GET/LIST operations. Not returned in createSandbox response. 
	Image ImageSpec `json:"image"`
	// Current lifecycle status and detailed state information
	Status SandboxStatus `json:"status"`
	// Custom metadata from creation request
	Metadata map[string]string `json:"metadata,omitempty"`
	// The command to execute as the sandbox's entry process. Always present in responses since entrypoint is required in creation requests. 
